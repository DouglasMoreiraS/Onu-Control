...
public class ListarEquipamentoView extends javax.swing.JDialog {

    EquipamentoControl eqControl;
    Frame parent;
    DefaultPieDataset pieDataSet;

    public ListarEquipamentoView(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ListarEquipamentoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            ListarEquipamentoView dialog = new ListarEquipamentoView(new javax.swing.JFrame(), true);
