...
public class ListarHistoricoView extends javax.swing.JDialog {

    HistoricoControl control;
    Frame parent;

    public ListarHistoricoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
    ...
    public ListarHistoricoView(java.awt.Frame parent, boolean modal, String equipamento) {
        super(parent, modal);
        this.parent = parent;
        control = new HistoricoControl();
        initComponents();
    ...
    public ListarHistoricoView(java.awt.Frame parent, boolean modal, String equipamento, String data, String observacao, String snEquipamento, boolean filtrar) {
        super(parent, modal);
        this.parent = parent;
        control = new HistoricoControl();
        initComponents();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ListarHistoricoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            ListarHistoricoView dialog = new ListarHistoricoView(new javax.swing.JFrame(), true);
